...
class OnPolicyRunnerCustom:
    ...
    #Dont forget to add a new train_cfg
    ...
    def log(self, locs: dict, width: int = 80, pad: int = 35):
        ...
        action_mean = self.alg.policy.action_mean.mean()
    ...
    def _construct_algorithm(self, obs) -> PPO | PPOCustom:
        ...
        actor_critic_class_name = self.policy_cfg["class_name"]
