...
class ActionsCfg:
    ...
    # torque_test = mdp.JointEffortActionCfg(
    #     asset_name="robot", 
    #     joint_names=[".*"],
    #     scale=1.0,
    #     offset=100.0,  # constant 10 Nm added to every joint
    # )
    ...
    mpc_action = mdp.BlindMPCActionCfg(
        asset_name="robot", 
        ...
        # ),
        action_range = (
            (-2.0, -2.0, -4.0,   -1.0, -1.0, -1.0,    -0.02,), # symmetric action space
            (2.0, 2.0, 4.0,       1.0, 1.0, 1.0,      .07,)
        ),
